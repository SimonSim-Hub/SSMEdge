...
var methods = {
    ...
    init : function( options ) {
        ...
        var defaults = {
            ...
            selectionCopy:true,
            // Allow Overflow Simon : tableOverflow -> tableOverflowX
            tableOverflowX:false,
            // Allow Overflow Simon : new -> tableOverflowY
            tableOverflowY:false,
            // Allow Overflow
            tableHeight:'300px',
            // About message
    ...
    setData : function(data, ignoreSpare) {
        ...
        // Scrolls Simon : Default Function
        ...
        if ($.fn.jexcel.defaults[id].tableOverflowY == true) {
        	$($.fn.jexcel.defaults[id].tableId).css('display', 'block');
        	$($.fn.jexcel.defaults[id].tableId).css('overflow-y', 'auto');
        	$($.fn.jexcel.defaults[id].tableId).css('height', 'auto');
        	$($.fn.jexcel.defaults[id].tableId).css('max-height', $.fn.jexcel.defaults[id].tableHeight);
        }
