                ...
                <div class="row">
                    <div class="col-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="insertUserMasterListForm" action="<%=request.getContextPath()%>/core/system/userManagement/insertUserMasterInfo" method="post">
                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-4 col-form-label">이름 :</label>
                                        <div class="col-sm-8">
                                            <input id="userName" data-validate="name" autocomplete="off" type="text" class="form-control enterEvent-insertUserMasterListBtn">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-4 col-form-label">아이디 :</label>
                                        <div class="col-sm-8">
                                            <input id="userId" data-validate="id" autocomplete="off" type="text" class="form-control enterEvent-insertUserMasterListBtn">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-4 col-form-label">이메일 :</label>
                                        <div class="col-sm-8">
                                            <input id="userEmail" data-validate="email" autocomplete="off" type="text" class="form-control enterEvent-insertUserMasterListBtn">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-4 col-form-label">비밀번호 :</label>
                                        <div class="col-sm-8">
                                            <input id="userPassword" data-validate="password" autocomplete="new-password" type="password" class="form-control enterEvent-insertUserMasterListBtn">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-4 col-form-label">비밀번호확인 :</label>
                                        <div class="col-sm-8">
                                            <input id="confirm_password" data-validate="confirm_password" type="password" class="form-control enterEvent-insertUserMasterListBtn">
                                        </div>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <button id="insertUserMasterListBtn" class="btn btn-block btn-success"  type="button">
                            사용자 정보 등록
                        </button>
                    </div>
                    <div class="col-9">
...
<script>
    $(function () {
        $(document).ready(function () {
            ...
            commonIncludeLeftMenuImageChange("Child", "userManagementInsertPage");
    ...
    $("#insertUserMasterListBtn").click(function() {
        if(!$.fn.validate($("#insertUserMasterListForm"))) {
            return false;
        } else {
            loadingStart("사용자 정보를 등록 중입니다. 잠시만 기다려주세요.");
        }

        const action = $("#insertUserMasterListForm").attr('action');
        ...
        $.ajax({
            ...
            success : function(resultData) {
                ...
                if(resultData.resultStatus == 1) {
                    $.fn.formReset($("#insertUserMasterListForm"));
                }
            },
            error : function(jqXHR, resultData) {
