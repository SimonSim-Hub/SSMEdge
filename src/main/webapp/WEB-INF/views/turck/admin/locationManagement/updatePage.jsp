                ...
                <div class="row">
                    <div class="col-3">
                        <div class="card card-warning card-outline">
                            ...
                            <div class="card-body">
                                <form id="updateLocationMasterInfoForm" action="<%=request.getContextPath()%>/turck/admin/locationManagement/updateLocationMasterInfo" method="post">
                                    <div class="form-group row">
                                        <label for="locationCode" class="col-sm-4 col-form-label">로케이션코드 :</label>
                                        <div class="col-sm-8">
                                            <input id="locationCode" disabled type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="locationName" class="col-sm-4 col-form-label">로케이션 :</label>
                                        <div class="col-sm-8">
                                            <input id="locationName" data-validate="null" autocomplete="off" type="text" class="form-control enterEvent-updateLocationMasterInfoBtn">
                                        </div>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <button id="updateLocationMasterInfoBtn" class="btn btn-block btn-warning"  type="button">
                            로케이션 정보 수정
                        </button>
                    </div>
                    <div class="col-9">
...
<script>
    $(function () {
        $(document).ready(function () {
            ...
            commonIncludeLeftMenuImageChange("Child", "locationManagementUpdatePage");
        ...
        $('#locationMasterList tbody').on('click', 'tr', function () {
            const data = table.row(this).data();

            $.fn.formReset($("#updateLocationMasterInfoForm"));
    ...
    $("#updateLocationMasterInfoBtn").click(function () {
        updateLocationMasterInfo();
    });
    ...
    function updateLocationMasterInfo() {
        loadingStart("로케이션 목록 수정 중 입니다. 잠시만 기다려주세요.");

        const action = $("#updateLocationMasterInfoForm").attr('action');
        ...
        $.ajax({
            ...
            error: function (jqXHR, resultData) {
                alarmPopUp(2, "로케이션 목록 수정 중 [" + jqXHR.status + "] 오류가 발생했습니다.<br>관리자에게 문의하세요.", "");
            },
            complete: function () {
                $.fn.formReset($("#updateLocationMasterInfoForm"));
