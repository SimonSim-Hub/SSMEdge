    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-3">
                        <form id="insertLocationMasterInfoForm"
                              action="<%=request.getContextPath()%>/turck/admin/locationManagement/insertLocationMasterInfo"
                              method="post">
                            <div class="card card-success card-outline">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="locationName" data-validate="null" autocomplete="off" type="text" class="form-control enterEvent-insertLocationMasterInfoBtn">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                        ...
                        <a id="insertLocationMasterInfoBtn" class="btn btn-success btn-block mb-3">로케이션 정보 등록</a>
                    </div>
                    <div class="col-9">
...
<script>
    $(function () {
        $(document).ready(function () {
            ...
            commonIncludeLeftMenuImageChange("Child", "locationManagementInsertPage");
    ...
    $("#insertLocationMasterInfoBtn").click(function () {
        insertLocationMasterList();
    });
    ...
    function insertLocationMasterList() {
        if(!$.fn.validate($("#insertLocationMasterInfoForm"))) {
            return false;
        } else {
            loadingStart("로케이션 목록 등록 중 입니다. 잠시만 기다려주세요.");
        }

        const action = $("#insertLocationMasterInfoForm").attr('action');
        ...
        $.ajax({
            ...
            error: function (jqXHR, resultData) {
                alarmPopUp(2, "로케이션 목록 등록 중 [" + jqXHR.status + "] 오류가 발생했습니다.<br>관리자에게 문의하세요.", "");
            },
            complete: function () {
                $.fn.formReset($("#insertLocationMasterInfoForm"));
