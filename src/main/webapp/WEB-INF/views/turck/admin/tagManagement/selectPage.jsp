    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-3">
                        <form id="selectTagMasterListForm" action="<%=request.getContextPath()%>/turck/admin/tagManagement/selectTagMasterList" method="post">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="tagName" autocomplete="off" type="text" class="form-control enterEvent-selectTagMasterListBtn">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                        ...
                        <a id="selectTagMasterListBtn" class="btn btn-primary btn-block mb-3">태그 목록 조회</a>
                    </div>
                    <div class="col-9">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
...
<script>
    $(function () {
        $(document).ready(function () {
            ...
            commonIncludeLeftMenuImageChange("Child", "tagManagementSelectPage");
    ...
    $("#selectTagMasterListBtn").click(function () {
        selectTagMasterList(1);
    });

    function selectTagMasterList(option) {
        if (!$.fn.validate($("#selectTagMasterListForm"))) {
            return false;
        } else {
            loadingStart("태그 목록 조회 중 입니다. 잠시만 기다려주세요.");
        }

        const action = $("#selectTagMasterListForm").attr('action');
